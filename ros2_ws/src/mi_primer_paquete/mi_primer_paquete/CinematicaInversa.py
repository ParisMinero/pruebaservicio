...
# Aquí es donde estaba cortado tu código original
xi = Matrix([T_0_p[0, 3],
             T_0_p[1, 3],
...
# Vector de velocidad en las juntas = jacobiano inverso * Velocidad de la trayectoria
...
# Posición, velocidad y aceleración en x, y, z
...
# Generar arreglos para guardar muestreo (Corregida la indentación)
...
# Muestreo (Corregida la indentación)
for i in range(samples):
...
# Cinemática inversa (Corregida la indentación)
for i in range(samples):
